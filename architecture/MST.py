...
if __name__ == "__main__":
    ...
    # model = AWAN(3, 31, 60, 8)
    # model = GLAF(3,mode='ds1')
    model = MST(dim=31,stage=3, num_blocks=[2,2,2])
    # model = DLCD(3)
    ...
    '''
    Parameters number is  4472166
    Parameters number is 4472122.0; Flops: 73030722560.0
    '''
